...
new_docker_compose_file_path = os.path.join(project_name, output_file)
with open(new_docker_compose_file_path, 'w') as new_file:
    new_file.write('# docker-compose file generated by ecr_config.py for aws-ecs fargate deploy')
